...
## bert_model_embedding_weights 어디서?
## BertPreTrainedModel 수정 필요!
...
class BertSelfAttention(nn.Module):
    def __init__(self, hidden_size, num_attention_heads, attention_probs_dropout_prob): #num_attention_heads = 12
...
class BertLayer(nn.Module):
    def __init__(self, hidden_size, num_attention_heads, attention_probs_dropout_prob, hidden_dropout_prob, intermediate_size, hidden_act):
...
class BertEncoder(nn.Module):
    def __init__(self, hidden_size, num_attention_heads, attention_probs_dropout_prob, hidden_dropout_prob, intermediate_size, hidden_act, num_hidden_layers):
        super(BertEncoder, self).__init__()
        layer = BertLayer(hidden_size, num_attention_heads, attention_probs_dropout_prob, hidden_dropout_prob, intermediate_size, hidden_act)
...
class BertOnlyMLMHead(nn.Module):
    def __init__(self, hidden_size, hidden_act, bert_model_embedding_weights):
        ...
        self.predictions = BertLMPredictionHead(hidden_size, hidden_act, bert_model_embedding_weights)
...
class BertPreTrainingHeads(nn.Module):
    def __init__(self, hidden_size, hidden_act, bert_model_embedding_weights):
        ...
        self.predictions = BertLMPredictionHead(hidden_size, hidden_act, bert_model_embedding_weights, bert_model_embedding_weights)
        self.seq_relationship = nn.Linear(hidden_size, 2)
...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, vocab_size, hidden_size, max_position_embeddings,
                 type_vocab_size, hidden_dropout_prob, num_attention_heads,
...
class BertForPreTraining(BertPreTrainedModel):
    ...
    def __init__(self, vocab_size, hidden_size, max_position_embeddings,
        ...
        self.bert = BertModel(vocab_size, hidden_size, max_position_embeddings,
                 ...
                 attention_probs_dropout_prob, intermediate_size,
                 hidden_act, num_hidden_layers)
        self.cls = BertPreTrainingHeads(hidden_size, hidden_act, bert_model_embedding_weights, self.bert.embeddings.word_embeddings.weight)
        self.apply(self.init_bert_weights)
...
class BertForMaskedLM(BertPreTrainedModel):
    ...
    def __init__(self, vocab_size, hidden_size, max_position_embeddings,
                 type_vocab_size, hidden_dropout_prob, num_attention_heads,
                 attention_probs_dropout_prob, intermediate_size,
                 hidden_act, num_hidden_layers, bert_model_embedding_weights):
        super(BertForMaskedLM, self).__init__()
        self.bert = BertModel(vocab_size, hidden_size, max_position_embeddings,
                 type_vocab_size, hidden_dropout_prob, num_attention_heads,
                 attention_probs_dropout_prob, intermediate_size,
                 hidden_act, num_hidden_layers)
        self.cls = BertOnlyMLMHead(hidden_size, hidden_act, bert_model_embedding_weights, self.bert.embeddings.word_embeddings.weight)
        self.apply(self.init_bert_weights)
...
class BertForNextSentencePrediction(BertPreTrainedModel):
    ...
    def __init__(self, vocab_size, hidden_size, max_position_embeddings,
        ...
        self.bert = BertModel(vocab_size, hidden_size, max_position_embeddings,
                 ...
                 attention_probs_dropout_prob, intermediate_size,
                 hidden_act, num_hidden_layers)
        self.cls = BertOnlyNSPHead(hidden_size)
        self.apply(self.init_bert_weights)
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, vocab_size, hidden_size, max_position_embeddings,
                 type_vocab_size, hidden_dropout_prob, num_attention_heads,
                 attention_probs_dropout_prob, intermediate_size,
                 hidden_act, num_hidden_layers, num_labels):
...
class BertForMultipleChoice(BertPreTrainedModel):
    ...
    def __init__(self, vocab_size, hidden_size, max_position_embeddings,
                 type_vocab_size, hidden_dropout_prob, num_attention_heads,
                 attention_probs_dropout_prob, intermediate_size,
                 hidden_act, num_hidden_layers, num_choices):
